...
export const metadata = {
  title: 'Tarina | Hietakulma Oy - Puurakentamisen erikoisosaaja',
  description:
    'Hietakulma Oy on kankaanpääläinen perheyritys. Yli 30 vuoden kokemus puuelementtitalojen ja kattoristikoiden suunnittelusta ja valmistuksesta.',
  keywords: ['Hietakulma', 'perheyritys', 'puutalovalmistaja', 'Kankaanpää'],
};
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-64 md:h-96 rounded-lg overflow-hidden shadow-lg">
            <Image
              ...
              alt="Hietakulman puuelementtitehdas Kankaanpäässä"
              fill
