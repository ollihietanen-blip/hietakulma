...
export default function Footer() {
  return (
    <>
      ...
      <footer className="py-12 md:py-16" style={{ backgroundColor: 'var(--dark)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            <Link
              href="/"
              aria-label="Hietakulma"
            ...
            <Link
              href="/ota-yhteytta"
              className="text-white font-semibold hover:underline mb-8 transition-colors"
            >
              Ota yhteyttä →
            </Link>
