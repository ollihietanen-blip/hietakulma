...
LUONNOS 0.1 · 12.9.2026 · Sisäinen tarkistus · Ei asiakasjakeluun
...
Aiemman tietopankin 11 nimikettä muodostavat tarkistuslistan. Vanhan käyttöliittymän otsikko ei osoita, että vastaava hyväksytty dokumentti olisi olemassa.
...
Jokaisesta dokumentista palautetaan muokattu luonnos sekä tieto siitä, mikä versio ja mitkä liitteet hyväksytään. Pelkkä yleinen kuittaus ei ratkaise avoimia teknisiä kohtia. Tarkistaja voi myös hylätä tarpeettoman nimikkeen tai ehdottaa sen yhdistämistä toiseen dokumenttiin.

Merkintä **LÄHDETIETO** tarkoittaa tarkistetusta aineistosta löytyvää tietoa, jonka nykyistä soveltuvuutta ei silti ole hyväksytty. **TARKISTETTAVA** tarkoittaa avointa tietoa tai ristiriitaa. **EHDOTUS** tarkoittaa tähän pakettiin kirjoitettua uutta sanamuotoa tai toimintatapaa.

Teknisiä arvoja ei siirretä julkiseen ohjeeseen ennen nimetyn asiantuntijan hyväksyntää. Hankekohtaiset kuormat, liitokset, nostot ja tuennat ratkaistaan kohteen hyväksytyissä suunnitelmissa. Luonnos ei ole asennuslupa tai rakennesuunnitelma.

## Julkaisuversion muodostaminen
